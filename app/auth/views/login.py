...
from app.config import CONNECT_WITH_PROTON, PROXY_ALLOW_LOGIN, DISABLE_REGISTRATION
...
def login():
    ...
    if use_email:
        ...
        elif not PROXY_ALLOW_LOGIN and not user.check_password(form.password.data):
            # Trigger rate limiter
            g.deduct_limit = True
