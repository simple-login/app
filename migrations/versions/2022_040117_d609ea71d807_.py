...
Revision ID: d609ea71d807
Revises: b500363567e3
Create Date: 2022-04-01 17:15:59.541023
...
def upgrade():
    ...
    op.create_index(op.f('ix_SMTP_credentials_alias_id'), 'SMTP_credentials', ['alias_id'], unique=False)
