...
def upgrade():
    ...
    op.create_index(
        op.f("ix_alias_mailbox_alias_id"), "alias_mailbox", ["alias_id"], unique=False
    )
    op.create_index(
        op.f("ix_alias_mailbox_mailbox_id"),
        "alias_mailbox",
        ["mailbox_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_email_log_contact_id"), "email_log", ["contact_id"], unique=False
    )
    op.create_index(
        op.f("ix_email_log_user_id"), "email_log", ["user_id"], unique=False
    )
