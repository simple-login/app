...
def upgrade():
    ...
    op.create_foreign_key(
        None, "alias_hibp", "alias", ["alias_id"], ["id"], ondelete="cascade"
    )
    op.create_foreign_key(
        None, "alias_hibp", "hibp", ["hibp_id"], ["id"], ondelete="cascade"
    )
...
def downgrade():
    ...
    op.drop_constraint(None, "alias_hibp", type_="foreignkey")
    op.create_foreign_key(
        "alias_hibp_alias_id_fkey", "alias_hibp", "alias", ["alias_id"], ["id"]
    )
    op.create_foreign_key(
        "alias_hibp_hibp_id_fkey", "alias_hibp", "hibp", ["hibp_id"], ["id"]
    )
    # ### end Alembic commands ###
