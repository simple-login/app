...
def upgrade():
    ...
    op.execute(
        "ALTER TABLE message_id_matching ALTER COLUMN original_message_id TYPE varchar(1024);"
    )
...
def downgrade():
    ...
    op.execute(
        "ALTER TABLE message_id_matching ALTER COLUMN original_message_id TYPE varchar(512);"
    )
