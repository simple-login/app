...
def upgrade():
    ...
    op.add_column(
        "client_user",
        sa.Column("default_avatar", sa.Boolean(), server_default="0", nullable=False),
    )
    op.add_column(
        "client_user",
        sa.Column(
            "name", sa.String(length=128), server_default=sa.text("NULL"), nullable=True
        ),
    )
    op.add_column(
        "gen_email",
        sa.Column("custom", sa.Boolean(), server_default="0", nullable=False),
    )
