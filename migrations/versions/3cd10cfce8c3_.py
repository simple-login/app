...
def upgrade():
    ...
    op.add_column(
        "authorization_code", sa.Column("scope", sa.String(length=128), nullable=True)
    )
    op.add_column(
        "oauth_token", sa.Column("redirect_uri", sa.String(length=1024), nullable=True)
    )
    op.add_column(
        "oauth_token", sa.Column("scope", sa.String(length=128), nullable=True)
    )
